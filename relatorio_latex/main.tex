...
Com todos os passos cumpridos o novo sensor ficou pronto a ser utilizado.
	...
	\tab Em termos de aplicação ROS, elaboramos dois tipos de programas. O primeiro contêm um nó que lê valores do sensor e publica esses dados
	...
	\tab Abaixo encontram-se os passos necessários para os executar:
