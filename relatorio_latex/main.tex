	...
	\begin{description}
	  \item[Robô] Robô Roomba 555 com interface USB
	  \item[API] \textit{Wrapper} para comunicar com o robô 
	  \item[Detector de Metal] LDC100EVM
	  \item[Computador] Dois portateis(um pequeno e um grande) com o sistema operativo Ubuntu\footnote{Ubuntu 13.04}
	  \item[Bobine] 1.71 mH
	  \item[Condensador] 3.09 nF
	  \item[LCR Meter] Versão 186
	  \item[Teclado] Teclado Wireless
	  \item[USB Hub] Quatro portas
	\end{description}
